...
class Footer extends React.Component {
	...
	render()
	{
		return (
			<footer>
				<div style={tailwind("flex flex-row justify-between flex-wrap m-8 footer-container mx-auto")}>
					...
					<div className="flex-column ">
						<h4 style={tailwind("mt-6 mb-3 font-bold")}>Команда</h4>
					...
					<div className="flex-column">
						<h4 style={tailwind("mt-6 mb-3 font-bold")}>Другие разделы</h4>
